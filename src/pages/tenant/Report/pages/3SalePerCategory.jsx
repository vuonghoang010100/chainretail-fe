...
const breadcrumbItems = [
  ...
  {
    title: "Báo cáo bán hàng nhóm sản phẩm",
  },
];
...
const Report = () => {
  ...
  const handleLabel = (data) => {
    const source = data.map(ele => ({
      TenNhomSanPham: ele[0],
      TongSoLuongBan: ele[1],
      TongDoanhThu: ele[2],
      LoiNhuan: ele[3],
    }))
  ...
  const handleRunReport = async () => {
    ...
    try {
      ...
      const responseData = await ReportSerivce.getReport(3, query)
