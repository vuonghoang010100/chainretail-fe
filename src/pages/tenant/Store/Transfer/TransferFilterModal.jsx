...
const TransferFilterModal = ({ open, setOpen, setQuery }) => {
  // -------------------- Filter attr --------------------
    ...
    >
      <Form name="filterStore" layout="vertical" form={form}>
        ...
        <Row {...rowProps}>
          ...
          <Col {...singleColProps}>
            <Form.Item name="fromStoreId" label="Cửa hàng gửi">
              <Input placeholder="Tìm theo mã cửa hàng gửi" allowClear />
            </Form.Item>
          </Col>

          <Col {...singleColProps}>
            <Form.Item name="toStoreId" label="Cửa hàng nhận">
              <Input placeholder="Tìm theo mã cửa hàng nhận" allowClear />
            </Form.Item>
          </Col>
          ...
          <Col {...singleColProps}>
            <Form.Item name="status" label="Trạng thái">
              <RadioGroup values={[VALUE_ALL, "Đang vận chuyển", "Hoàn thành", "Đã hủy"]} />
            </Form.Item>
          </Col>
